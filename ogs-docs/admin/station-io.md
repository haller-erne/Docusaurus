...
Note, that you can also use the OpenProtocol custom IO signals for IO. This is not covered here, see the [OpenProtocol tools](../tool-config/openprotocol/index.md) section for more information.
