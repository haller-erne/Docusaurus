...
<img style={{float: 'right', margin: '0 0 1rem 1rem'}} width="300" src={require('./resources/ke350-openprotocol-settings.png').default} alt="KE350 OpenProtocol settings" />
/// caption
...
![Database settings](resources/heOpCfg-settings.png)
...
Even though there are more option (see the general discussion in [OpenProtocol Tools - Loosen modes](index.md#loosen-modes)), the following section shows the common and recommended configurations.
...
![Jäger Handling e-Handle](resources/e-handle-Übersicht.png)
