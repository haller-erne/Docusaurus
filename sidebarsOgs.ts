      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {type: 'doc', id: 'tools/openprotocol/pf6-pf8', label: 'Atlas Copco PowerFocus 4000/6000/8'},
            {type: 'doc', id: 'tools/openprotocol/mtc', label: 'Atlas Copco MicroTorque'},
        ...
        },
        {
          ...
          items: [
            ...
            {type: 'doc', id: 'tools/misc/hikrobot-vm-tcp', label: 'HikRobot VisionMaster'},
      ...
      items: [
        {type: 'doc', id: 'v3/getting-started', label: 'Getting Started'},
        {
          ...
          items: [
            ...
            {type: 'doc', id: 'v3/lua/database', label: 'Database access'},
            {type: 'doc', id: 'v3/lua/userrights', label: 'User rights'},
          ],
        },
