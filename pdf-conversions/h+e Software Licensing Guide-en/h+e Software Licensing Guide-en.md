...
Start à All Programs à Bosch Rexroth AG à ww\_hhà License manager
...
Start à Bosch Rexroth AG à Operator Guidance System à License manager
...
Then use the "Save to Clipboard" button or copy & paste the "Registration Code". Put the text into an email and send it to [c](mailto:activation@haller-erne.de)[ontact@haller-erne.de](mailto:contact@haller-erne.de) or activation@haller-erne.de to request a license file based on the licensing information and serial number of the software. Your license file will be emailed to you.
